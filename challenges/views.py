...
def complete_challenge(request, challenge_id):
    ...
    if request.user in challenge.completed_by.all():
        return HttpResponse("✅ You've already completed this challenge!")
    
    challenge.completed_by.add(request.user)
    challenge.save()
    return HttpResponse("🎉 Challenge completed successfully!")
